"""
Categorization logic and descriptive pattern lookup table for filesystem & fsspec methods.
"""

from typing import Dict

# Known descriptive pattern lookup table for top methods
...
def categorize_method(name: str) -> str:
    """Categorize method into a clean functional domain."""
    n = name.lower()
    if any(
        k in n
        for k in [
